...
<div className="navbar bg-slate-800">
  ...
  <div className="">
    <a className="bg-black text-white p-3 py-2 rounded-md cursor-pointer hover:bg-grey duration-300" onClick={()=>document.getElementById("my_modal_3").showModal()}>Login</a>
    <Login /> 
  </div>
</div>
</div>
